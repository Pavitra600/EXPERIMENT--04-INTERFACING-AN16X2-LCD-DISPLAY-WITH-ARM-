...
{
    Lcd_cursor(&lcd, 0, 1);
    Lcd_string(&lcd, "PAVITRA\n");

    Lcd_cursor(&lcd, 1, 1);
    Lcd_string(&lcd, "212224110043\n");
}
...
## Output screen shots of proteus  :
 ...
 ![WhatsApp Image 2025-09-17 at 09 07 35_4b9233f5](https://github.com/user-attachments/assets/615f0273-429a-4e1f-bad2-a4d4ea596e2d)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 <img width="869" height="646" alt="image" src="https://github.com/user-attachments/assets/faa618f6-cd72-4acd-a156-aa2db502eab8" />
